...
#   CLEANUP_MIN_FREE_GIB   then keep deleting until this much is free (100)
...
while true; do
  ...
  # this: it prunes unreferenced BUILD dirs, while what grows is the
  # accumulation of PAST builds' installed trees and tarballs.
  #
  ...
  for _container in $CUR_CONTAINERS; do
    ...
    cleanup.py -t "${CLEANUP_MAX_AGE_DAYS:-2}" -f "${CLEANUP_MIN_FREE_GIB:-100}" \
