...
cat > "$CONFIG_TMP" <<JSON
{
  ...
  "attended_slots": {"github-token-rw": {"ttl": 900}, "nomad-rw": {"ttl": 900},
                     ...
                     "consul-rw": {"ttl": 900},
                     "consul-admin": {"ttl": 300, "max_uses": 5},
                     "vault-admin": {"ttl": 300, "max_uses": 5}},
  "routes": [
    ...
    {"name": "consul-rw", "upstream": "https://aliconsul.cern.ch",
     "auth_header": "X-Consul-Token", "inject_headers": {"X-Consul-Token": {"ingest": "consul-rw"}}},
    {"name": "consul-admin", "upstream": "https://aliconsul.cern.ch",
     "auth_header": "X-Consul-Token", "inject_headers": {"X-Consul-Token": {"ingest": "consul-admin"}}},
    {"name": "vault", "upstream": "https://alivault.cern.ch",
     "auth_header": "X-Vault-Token", "inject_headers": {"X-Vault-Token": {"ingest": "vault"}}},
    {"name": "vault-admin", "upstream": "https://alivault.cern.ch",
     "auth_header": "X-Vault-Token", "inject_headers": {"X-Vault-Token": {"ingest": "vault-admin"}}},
